        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    nome_paciente = table.Column<string>(type: "varchar(50)", nullable: false),
                    email_pacitente = table.Column<string>(type: "varchar(70)", nullable: true),
                    celular_paciente = table.Column<string>(type: "varchar(25)", nullable: false),
                    cpf_paciente = table.Column<string>(type: "varchar(11)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    nome_profissional = table.Column<string>(type: "varchar(50)", nullable: false),
